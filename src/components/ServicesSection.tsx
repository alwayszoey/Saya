...
function ServiceTitleWithBadges() {
  return (
    <>
      ดีไซน์ <span className="service-title-badge">UI</span>
      <span className="service-title-sep">/</span>
      <span className="service-title-badge">UX</span> สำหรับเว็บไซต์
    </>
  );
}
            ...
            <>
              <div className="service-hero-copy">
                <h3 className="service-hero-title">
                  {uiUxBadges ? <ServiceTitleWithBadges /> : title}
                </h3>
